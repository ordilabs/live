    ...
    view! {cx,
        ...
        <div class="space-y-6 pb-16">
            ...
            <div class="flex gap-x-3">
                <button type="button"
                    class="flex-1 rounded-md bg-red-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">"Share"</button>
                <button type="button"
                    class="flex-1 rounded-md bg-red-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">"Download"</button>
            </div>
        </div>
    </aside>}
}
