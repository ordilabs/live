        ...
        <div class="flex h-16 justify-between">
          ...
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <a href="https://github.com/ordilabs/live" target="_blank" class="relative inline-flex items-center gap-x-1.5 rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500">
    ...
    view! {
        ...
        <div class="mx-auto max-w-7xl py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div class="flex justify-center space-x-6 md:order-2">
            ...
            <a href="https://github.com/ordilabs/live" class="text-gray-400 hover:text-gray-500 dark:text-gray-100">
